#' Plotting opioid overdoses by age group
#'
...
#'
#' @examples
#' `plotting_opioid_overdoses_by_age_group(clean_opioid_overdose_ed_visits_data, clean_population_estimates_and_projections_data, n)`
#' `plotting_opioid_overdoses_by_age_group(clean_opioid_overdose_hospitalizations_data, clean_population_estimates_and_projections_data, rate)`
plotting_opioid_overdoses_by_age_group <- function(clean_opioid_overdose_data, clean_population_estimates_and_projections_data, measure) {
  ...
  joining_opioid_overdose_and_population_data_by_age_group(
