#' Joining opioid overdose and population data by quarter
#'
...
#'
#' @examples
#' `joining_opioid_overdose_and_population_data_by_quarter(clean_ed_visits_data, clean_population_estimates_and_projections_data)`
#' `joining_opioid_overdose_and_population_data_by_quarter(clean_hospitalizations_data, clean_population_estimates_and_projections_data)`
joining_opioid_overdose_and_population_data_by_quarter <- function(clean_opioid_overdose_data, clean_population_estimates_and_projections_data) {
  aggregating_opioid_overdose_data_by_quarter(clean_opioid_overdose_data) %>%
